...
public class MessageServiceTest {
    ...
    @Test
    public void sendMessage_UserNotInChat() {
        Integer userId = 1;
        Integer chatId = 1;
        String content = "Test message";
    ...
    @Test
    public void getChatHistory_Success() {
        Integer userId = 1;
        Integer chatId = 1;
    ...
    @Test
    public void getChatHistory_UserNotInChat() {
        Integer userId = 1;
        Integer chatId = 1;
