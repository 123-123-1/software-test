...
public class UserServiceTest {
    ...
    @Test
    public void register_Success_RegularUser() throws Exception {
        // Prepare test data
    ...
    @Test
    public void register_Success_VenueAdmin() throws Exception {
        // Prepare test data
        RegisterRequestDTO requestDTO = new RegisterRequestDTO();
    ...
    @Test
    public void getUserList_EmptyList() {
    ...
    @Test
    public void getUsersByName_NoUsersFound() {
    ...
    @Test
    public void getUserInfo_UserNotFound() {
        Integer userId = 999;
    ...
    @Test
    public void updateUserPwd_Success() throws Exception {
        Integer userId = 1;
        User existingUser = new User();
        existingUser.setUserId(userId);
    ...
    @Test
    public void updateUserPwd_UserNotFound() {
        Integer userId = 999;
        UpdatePwdDTO updatePwdDTO = new UpdatePwdDTO();
        updatePwdDTO.setOldPwd("oldPassword");
        updatePwdDTO.setNewPwd("newPassword");
    ...
    @Test
    public void updateUserPwd_WrongOldPassword() {
        Integer userId = 1;
        User existingUser = new User();
        existingUser.setUserId(userId);
        existingUser.setUserName("testUser");
    ...
    @Test
    public void getUserNotification_Success() throws Exception {
        Integer userId = 1;
    ...
    @Test
    public void getUserNotification_EmptyList() throws Exception {
        Integer userId = 1;
    ...
    @Test
    public void sendUserNotification_Success() {
    ...
    @Test
    public void editUserNotification_Success() {
    ...
    @Test
    public void editUserNotification_NotFound() {
        NotificationOperationDTO operationDTO = new NotificationOperationDTO();
    ...
    @Test
    public void updateUserAvatar_Success() throws Exception {
        Integer userId = 1;
        String avatarUrl = "http://example.com/avatar.jpg";
    ...
    @Test
    public void updateUserAvatar_UploadError() throws Exception {
        Integer userId = 1;
        String avatarName = "avatar_" + userId;
    ...
    @Test
    public void isUserAdmin_UserNotFound() {
        Integer userId = 999;
